...
//             case 'soup':
//                 totalAmount -= soupAmount;
//                 soupAmount = dish.price;
//                 soupSelect.innerHTML = `<option value="${dish.keyword}" selected>${dish.name} ${soupAmount}₽</option>`;
//                 totalAmount += soupAmount;
//                 break;
//             case 'main-course':
...
//                 break;
//             case 'beverage':
//                 beverageAmount +=dish.price;
                
//                 drinkSelect.innerHTML = `<option value="${dish.keyword}" selected>${dish.name} ${beverage_temp}₽</option>`;
//                 break;
//         }
